...
const EVOLVE_META: Record<EvolveLevel, { icon: string; label: string; color: string; bg: string }> = {
  larva: { icon: '/levels/larva.png', label: 'Larva',  color: 'text-zinc-400',    bg: 'bg-zinc-500/10' },
  pupa:  { icon: '/levels/pupa.png', label: 'Pupa',   color: 'text-amber-300',   bg: 'bg-amber-500/10' },
  imago: { icon: '/levels/imago.png', label: 'Imago',  color: 'text-violet-300',  bg: 'bg-violet-500/10' },
  ghost: { icon: '/levels/ghost.png', label: 'Ghost',  color: 'text-fuchsia-300', bg: 'bg-fuchsia-500/10' },
};
