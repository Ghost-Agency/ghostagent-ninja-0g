        ...
        <div className="rounded-2xl border border-[rgba(176,128,92,0.35)] bg-[var(--card)] p-5 space-y-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2 md:grid-cols-5">
              {([
                {k:'ens' as NftType,l:'ENS Name',img:'https://ipfs.io/ipfs/bafkreifv35abvqlhdtc4g2i4xelnmxnhaac7exyu6r24o3fbgthwcmupwy'},
                ...
                {k:'normie' as NftType,l:'NORMIES\nON ETH',img:'https://ipfs.io/ipfs/bafkreigdisoyfs75rneioevm5irn2k4prdddtuum5bpn27bykhjtdc4fii'},
                {k:'other' as NftType,l:'Other Verified ERC721',img:'https://ipfs.io/ipfs/bafkreid7jamriw5jneuarcq2q6lrbfsqe76eebv6r2rworrnhyj2rpsuem'},
              ]).map(opt => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="relative h-10 w-10 shrink-0 overflow-hidden rounded-full border-2 border-fuchsia-500/30">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img 
                      src="https://ipfs.io/ipfs/bafkreifm4gtqaxgyb2quyykij4np5naoxzpf5w6za6maywemcvl7tltt7u" 
                      ...
                      <div className="flex items-center gap-2">
                        <div className="relative h-8 w-8 shrink-0 overflow-hidden rounded-full border border-amber-500/30">
                          {(agent as any).imageUrl ? (
                            ...
                            <img 
                              src={
                                agent.tld === 'nftmail.gno' ? 'https://ipfs.io/ipfs/bafkreifv35abvqlhdtc4g2i4xelnmxnhaac7exyu6r24o3fbgthwcmupwy' :
                                agent.tld === 'molt.gno' ? 'https://ipfs.io/ipfs/bafkreifm4gtqaxgyb2quyykij4np5naoxzpf5w6za6maywemcvl7tltt7u' :
                                agent.tld === 'openclaw.gno' ? 'https://ipfs.io/ipfs/bafkreiczeqhex35dvj4ewbzn2gyqnbgqb22np5zgp223vnbfhaod6sv4sq' :
                                agent.tld === 'vault.gno' ? 'https://ipfs.io/ipfs/bafkreick55xkc2ucnmk2wjbzl6a5chqkvmwjll4oqbqajfh5mapd3s7fku' :
                                agent.tld === 'agent.gno' ? 'https://ipfs.io/ipfs/bafkreigdisoyfs75rneioevm5irn2k4prdddtuum5bpn27bykhjtdc4fii' :
                                'https://ipfs.io/ipfs/bafkreid7jamriw5jneuarcq2q6lrbfsqe76eebv6r2rworrnhyj2rpsuem'
                              }
                              alt={agent.tld ?? 'agent'}
                              className="h-full w-full object-cover"
                            />
